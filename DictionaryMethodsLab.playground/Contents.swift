...
var starWarsVillians = ["Darth Vadar", "Emperor Palpatine"]
/*: question3
...
for characters in starWarsCharacters.keys {
    print(characters)
}
/*: question10
...
for characters in starWarsCharacters {
    print(characters)
}
/*: question14
